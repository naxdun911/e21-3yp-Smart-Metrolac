...
// Nav items for the collection center admin section.
const NAV_LINKS = [
  { label: 'Dashboard',       to: '/center/dashboard' },
  { label: 'Farmers',         to: '/center/farmers'   },
  { label: 'Invoices',        to: '/center/invoices'  },
  { label: 'Payments',        to: '/center/payments'  },
  { label: 'Alerts',          to: '/center/alerts'    },
